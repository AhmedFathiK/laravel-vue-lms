...
import AddressContent from '@/views/checkout/Address.vue'
import CartContent from '@/views/checkout/Cart.vue'
import ConfirmationContent from '@/views/checkout/Confirmation.vue'
import PaymentContent from '@/views/checkout/Payment.vue'

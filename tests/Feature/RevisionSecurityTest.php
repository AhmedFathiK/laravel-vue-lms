...
class RevisionSecurityTest extends TestCase
{
    ...
    public function test_user_without_revision_capability_cannot_access_revision_api()
    {
        // Grant Basic Entitlement WITHOUT revision capability
    ...
    public function test_user_with_revision_capability_can_access_revision_api()
    {
        // Grant Entitlement WITH revision capability
        $plan = BillingPlan::create([
            'name' => 'Pro Plan',
            'price' => 10,
            'currency' => 'USD',
